// Função para somar os números fornecidos pelo usuário
function somarNumeros() {
    let soma = 0;
    let continuar = true;

    // Estou usando let para trabalhar valores no bloco de função.
...
// Chama a função para iniciar o processo de soma
somarNumeros();